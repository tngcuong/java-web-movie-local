  ...
  ======================================================== -->
   <script type="text/javascript">
	function delete_movie(movieId){
		if(confirm("Sure to delete movie with id: "+ movieId +" ?")){
			window.location = "delete_movie?id="+movieId;
		}
	}
</script>
</head>
				...
				<div class="col-lg-12">
					<div class="card">
						<div class="card-body">
							...
							<a href="add-movie" class="btn btn-primary mb-3">Add movie</a>
								...
								<%int i=0; %>
									...
									<%i++; %>
										<tr>
											...
											<td>${movie.describeMovie}</td>
											<td>${movie.status}</td>
											<td>
												<a href="update_movie?id=${movie.movieId}"><i class="fa-solid fa-pen-to-square"></i></a> | 
												<a href="#" onclick="delete_movie('${movie.movieId}')"><i class="fa-solid fa-trash"></i></a>
											</td>
										</tr>		
									</c:forEach>																
								</tbody>
