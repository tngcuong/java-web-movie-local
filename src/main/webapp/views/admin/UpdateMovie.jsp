						...
						<c:set var="movie" value="${requestScope.movie}"></c:set>
							...
							<form action="update_movie" method="post" enctype="multipart/form-data">
								<div class="row mb-3">
									...
									<div class="col-sm-10">
										<input type="text" value="${movie.movieId}" name="id" class="form-control"  readonly="readonly">
									</div>
								</div>
								<div class="row mb-3">
									<label for="" class="col-sm-2 col-form-label">Name :</label>
									<div class="col-sm-10">
										<input type="text" value="${movie.nameMovie}" name="name" class="form-control">
									</div>
								</div>
								<div class="row mb-3">
									<label for="" class="col-sm-2 col-form-label">Image :</label>
									<div class="col-sm-10">
										<input type="text" name="img" class="form-control" value="${movie.imgPath}">
									</div>
								</div>
								<div class="row mb-3">
									<label for="" class="col-sm-2 col-form-label">Price :</label>
									<div class="col-sm-10">
										<input type="number" min="0" name="price" class="form-control" value="${movie.price}" >
									</div>
								</div>
								<div class="row mb-3">
								...
								<div class="row mb-3">
									...
									<div class="col-sm-10">
										<input type="text" name="describe" class="form-control" value="${movie.describeMovie}">
									</div>
								</div>
								<div class="row mb-3">
