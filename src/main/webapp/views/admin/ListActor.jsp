  ...
  ======================================================== -->
   <script type="text/javascript">
	function delete_actor(actorId){
		if(confirm("Sure to delete actor with id: "+ actorId +" ?")){
			window.location = "delete_actor?id="+actorId;
		}
	}
</script>
</head>
				...
				<div class="col-lg-12">
					<div class="card">
						<div class="card-body">
							...
							<a href="add-actor" class="btn btn-primary mb-3">Add actor</a>
								...
								<%int i=0; %>
									...
									<%i++; %>
										<tr>
											...
											<td>
												<a href="update_actor?id=${actor.actorId}"><i class="fa-solid fa-pen-to-square"></i></a> | 
												<a href="#" onclick="delete_actor('${actor.actorId}')"><i class="fa-solid fa-trash"></i></a>
											</td>
										</tr>		
									</c:forEach>																
								</tbody>
