	...
	<header class="header-v3">
		...
		<div class="container-menu-desktop trans-03">
			<div class="wrap-menu-desktop">
				...
				<nav class="limiter-menu-desktop p-l-45">
					...
					<!-- Logo desktop -->		
					<a title="Home" href="/WebSiteFilm/Home" class="logo">
		...
		<div class="wrap-header-mobile">
			...
			<div class="logo-mobile">
				<a href="Home"><img src="views/user/assets/images/icons/logo-01.png" alt="IMG-LOGO"></a>
			</div>
			...
			<div class="sidebar-content flex-w w-full p-lr-65 js-pscroll">
				...
				<ul class="sidebar-link w-full">
					...
					<%String permission2 = (String)session.getAttribute("permission");
						if(permission2.equals("admin") || permission2.equals("")){
							%>
...
<%@include file="Layout/Header.jsp" %>
	...
	<section class="section-slide">
		<div class="wrap-slick1 rs2-slick1">
			<div class="slick1">
				<div class="item-slick1 bg-overlay1" style="background-image: url(${url}/images/slider1.jpg);" data-thumb="images/thumb-01.jpg" data-caption="Women’s Wear">
				...
				<div class="item-slick1 bg-overlay1" style="background-image: url(${url}/images/slide2.jpg);" data-thumb="images/thumb-02.jpg" data-caption="Men’s Wear">
					<div class="container h-full">
						<div class="flex-col-c-m h-full p-t-100 p-b-60 respon5">
				...
				<div class="item-slick1 bg-overlay1" style="background-image: url(${url}/images/slide3.jpg);" data-thumb="images/thumb-03.jpg" data-caption="Men’s Wear">
					<div class="container h-full">
						<div class="flex-col-c-m h-full p-t-100 p-b-60 respon5">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="views/user/assets/images/${movie.imgPath}" alt="IMG-PRODUCT">

							<a href="view-detail-movie?id=${movie.movieId}" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 ">
								Quick View
							</a>   
						</div>
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="view-detail-movie?id=${movie.movieId}" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
									${movie.nameMovie }
								</a>
							...
							<div class="block2-txt-child2 flex-r p-t-3">
								<a href="#" class="btn-addwish-b2 dis-block pos-relative js-addwish-b2">
									<img class="icon-heart1 dis-block trans-04" src="views/user/assets/images/icons/icon-heart-01.png" alt="ICON">
									<img class="icon-heart2 dis-block trans-04 ab-t-l" src="views/user/assets/images/icons/icon-heart-02.png" alt="ICON">
								</a>
							</div>
						</div>
					</div>
			...
			<div class="p-t-40">
				<div class="flex-c-m flex-w p-b-18">
					<a href="#" class="m-all-1">
						<img src="views/user/assets/images/icons/icon-pay-01.png" alt="ICON-PAY">
					</a>

					<a href="#" class="m-all-1">
						<img src="views/user/assets/images/icons/icon-pay-02.png" alt="ICON-PAY">
					</a>

					<a href="#" class="m-all-1">
						<img src="views/user/assets/images/icons/icon-pay-03.png" alt="ICON-PAY">
					</a>

					<a href="#" class="m-all-1">
						<img src="views/user/assets/images/icons/icon-pay-04.png" alt="ICON-PAY">
					</a>

					<a href="#" class="m-all-1">
						<img src="views/user/assets/images/icons/icon-pay-05.png" alt="ICON-PAY">
					</a>
				</div>

				<p class="stext-107 cl6 txt-center">
					<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="#" target="_blank">CUOG</a>  <a href="#" target="_blank"></a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
		...
		<div class="container">
			<div class="bg0 p-t-60 p-b-30 p-lr-15-lg how-pos3-parent">
				<button class="how-pos3 hov3 trans-04 js-hide-modal1">
					<img src="views/user/assets/images/icons/icon-close.png" alt="CLOSE">
				</button>
								...
								<div class="slick3 gallery-lb">
									<div class="item-slick3" data-thumb="images/product-detail-01.jpg">
										<div class="wrap-pic-w pos-relative">
											<img src="views/user/assets/images/${movieDetail.imgPath }" alt="IMG-PRODUCT">
